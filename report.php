 ...
 * 注意：这里的 token 原文必须和客户端 /opt/simple/env 中的 TOKEN 完全相同！
 */
$TOKENS = [
    "请替换为你的token原文1" => "Oracle ARM Singapore",
    "请替换为你的token原文2" => "Oracle ARM Hyderabad",
    "请替换为你的token原文3" => "Oracle AMD Hyderabad",
    "请替换为你的token原文4" => "Oracle AMD Sanjose",
    "请替换为你的token原文5" => "HomeCloud"
];
// ==========================================
